      ...
      css.walkRules(function (rule) {
        ...
        rule.walkDecls(function (decl, i) {
          ...
          if (opts.landscape && params && params.indexOf('landscape') !== -1) {
            ...
            size = getSize(opts.landscapeWidth, rule.source.input);
          } else {
            unit = getUnit(decl.prop, opts);
            size = getSize(opts.viewportWidth, rule.source.input);
          }
...
function getSize (width, input) {
  return typeof width === 'function' ? width(input) : width;
}
